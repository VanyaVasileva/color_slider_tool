...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* Fester, quadratischer Vorschau-Rahmen. Breite ist responsiv (max 560px),
     aber Position ist immer mittig (margin:0 auto) und die Groesse aendert
     sich nie waehrend der Farbauswahl - nur beim Browser-Resize. */
  .preview-box {
    position: relative;
    width: 100%;
    max-width: 560px;
...
(() => {
  ...
  // Setzt die Canvas-Aufloesung (Pixel-Buffer) passend zur festen Rahmengroesse.
  // Wird NUR beim ersten Laden und bei einer echten Fenstergroessenaenderung
  // aufgerufen - niemals beim Hochladen eines Bildes oder bei der Farbauswahl.
  // Dadurch kann sich die Vorschau waehrend des Sliderns nie mehr verschieben.
  ...
  // Malt nur Pixel (Hintergrundfarbe + Bild "contain"-skaliert und zentriert
  // im festen Rahmen). Fasst nie die Canvas-Groesse an.
